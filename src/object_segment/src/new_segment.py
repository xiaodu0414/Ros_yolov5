...
def imgmsg_to_cv2(img_msg):
    ...
    print("Width and height of the received picture ：",img_msg.width,img_msg.height)
...
def sub_receive_img():
    #订阅带图节点
    rospy.Subscriber("/object_location/object_image",ObjectImage,callback_receive_img)    
    # rospy.Subscriber("/object_location/object_detection",ObjectDetect,callback_receive_img_info)    
        ...
        try:
            ...
            for i, det in enumerate(pred):
                ...
                if len(det):
                    ...
                    for j, (*xyxy, conf, cls) in enumerate(reversed(det[:, :6])):
                        if send_result:
                            ...
                            if cls == 1:        
                                ...
                                msg.polygons.append(_polygon)                                                                             ## right_side
                    ...
                    print("Confidence",msg.object_confidences)
